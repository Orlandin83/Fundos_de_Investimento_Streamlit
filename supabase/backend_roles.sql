...
DROP POLICY IF EXISTS benchmarks_backend_leitura ON public.benchmarks_diarios;
CREATE POLICY benchmarks_backend_leitura ON public.benchmarks_diarios FOR SELECT TO fundos_app, fundos_coletor USING (true);
...
DROP POLICY IF EXISTS benchmarks_coletor_escrita ON public.benchmarks_diarios;
CREATE POLICY benchmarks_coletor_escrita ON public.benchmarks_diarios FOR ALL TO fundos_coletor USING (true) WITH CHECK (true);
